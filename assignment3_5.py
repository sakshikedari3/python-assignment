import sys
from assignment_marvollusNum import prime 
...
def main():
    ...
    if len(sys.argv) > 2 :
        ...
        if sys.argv[1] == "--h" :
            print("this program is use to add prime number in given list")
            return
        ...
        size = int(input("Enter the number of elemnts you want to enter : "))
